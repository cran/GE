#' @export
#' @title An Overlapping Generations Model with a Financial Instrument
#' @aliases gemOLGFinancialInstrument
#' @description Some examples of an overlapping generations model with a financial instrument (i.e. financial OLG model, FOLG model).
...
gemOLGFinancialInstrument <- function(...) sdm2(...)
