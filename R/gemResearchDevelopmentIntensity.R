...
#' f.TGR <- function(RDLevel) RDEffectivenessCoefficient * RDLevel
#'
#' f <- function() {
#'   sdm2(
...
#'           technology.progress.rate <- f.TGR(last.RDLevel)
...
#' RDIntensity <- 0.3
#' node_set(dst.firm, "cc1", a = 1)
#' f.TGR <- function(RDLevel) max(0, rnorm(1, RDEffectivenessCoefficient * RDLevel,
