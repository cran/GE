#' @export
#' @title A Time-Circle Model (Closed Loop Overlapping Generations Model)
#' @aliases gemOLGTimeCircle
#' @description Some examples of a time-circle model, which usually contains overlapping generations.
...
gemOLGTimeCircle <- function(...) sdm2(...)
