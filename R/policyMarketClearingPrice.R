...
#' In this case, the path of the economy is the spot equilibrium path.
#' Generally, this function is passed to the function sdm2 as an argument to compute the spot equilibrium path.
