...
#'
#' A spot equilibrium path and a disequilibrium path will be calculated below.
#' The spot equilibrium path will converge to the stochastic equilibrium consisting of two equilibrium states, and the disequilibrium paths not.
