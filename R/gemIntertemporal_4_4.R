...
#' @description An intertemporal (timeline) model with land, two consumers (i.e. a laborer and a land owner) and two types of firms.
#' The firms have CESAK production functions.
